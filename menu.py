...
from display_nn import NeuralNetwork
...
class Menu():
    def __init__(self, args, caption="Main menu_main"):
        ...
        self.winner_nn = NeuralNetwork(self.screen)
    ...
    def __create_select_track_menu__(self, theme):
        self.select_track_menu = pygame_menu.Menu("Arguments", 400, 150, theme=self.theme)
    ...
    def __create_arguments_menu__(self, theme):
        self.arguments_menu = pygame_menu.Menu("Arguments", 400, 385, theme=self.theme)
    ...
    def __create_main_menu__(self, caption, theme):
        ...
        self.menu_main = pygame_menu.Menu(self.caption, 400, 315, theme=self.theme)
